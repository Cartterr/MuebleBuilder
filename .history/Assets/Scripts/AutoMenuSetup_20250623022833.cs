...
namespace VRProject
{
    ...
    public class AutoMenuSetup : MonoBehaviour
    {
                ...
                private void CreateInstructionPanelIfNotExists()
        {
            ...
            panelRoot.transform.localScale = Vector3.one * 0.005f;
            ...
            scaler.scaleFactor = 0.00000025f;
            ...
            canvasRect.sizeDelta = new Vector2(10, 2.5f);
            ...
            bgRect.sizeDelta = new Vector2(10, 2.5f);
        ...
        private GameObject CreateRoundedPanel(string name, Transform parent)
        {
            ...
            Texture2D roundedTexture = CreateRoundedRectTexture(100, 50, 8);
