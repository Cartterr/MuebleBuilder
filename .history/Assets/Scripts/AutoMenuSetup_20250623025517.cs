...
namespace VRProject
{
    ...
    public class AutoMenuSetup : MonoBehaviour
    {
                ...
                private void CreateInstructionPanelIfNotExists()
        {
            ...
            textRect.anchorMin = Vector2.zero;
            textRect.anchorMax = Vector2.one;
            textRect.offsetMin = new Vector2(0.002f, 0.001f);
            textRect.offsetMax = new Vector2(-0.002f, -0.001f);
            ...
            instructionText.fontSize = 0.008f;
            instructionText.color = new Color(1f, 1f, 0.8f, 1f);
        ...
        private GameObject CreateRoundedPanel(string name, Transform parent)
        {
            ...
            Texture2D roundedTexture = CreateRoundedRectTexture(30, 15, 5);
