...
namespace VRProject
{
    public class AutoMenuSetup : MonoBehaviour
    {
        ...
        public void CreateCanvas()
        {
            ...
            canvasRect.sizeDelta = new Vector2(5, 3.75f);
        ...
        {
            // Title
            CreateText("MuebleBuilder", parent, new Vector2(0, 0.625f), 0.375f);

            // Iniciar Button
            CreateButton("IniciarButton", "INICIAR", parent, new Vector2(0, 0), new Vector2(1.5f, 0.5f));

            // Salir Button
            CreateButton("SalirButton", "SALIR", parent, new Vector2(0, -0.625f), new Vector2(1.5f, 0.5f));
        }

                                private void CreateModelSelectionContent(Transform parent)
        {
            // Title
            CreateText("Selecciona tu Mueble", parent, new Vector2(0, 1.5f), 0.25f);

            // Back Button
            CreateButton("BackButton", "◀ VOLVER", parent, new Vector2(-1.875f, 1.5f), new Vector2(1.25f, 0.375f));
        ...
        private void CreateText(string text, Transform parent, Vector2 position, float fontSize)
        {
            ...
            rect.anchoredPosition = position;
            rect.sizeDelta = new Vector2(2.5f, 0.5f);
        ...
        private void CreateScrollView(Transform parent)
        {
            ...
            scrollRect.sizeDelta = new Vector2(3.75f, 1.875f);
            ...
            contentRect.pivot = new Vector2(0.5f, 1);
                                                contentRect.sizeDelta = new Vector2(0, 3.75f);

            GridLayoutGroup grid = content.AddComponent<GridLayoutGroup>();
            grid.cellSize = new Vector2(0.75f, 0.75f);
            grid.spacing = new Vector2(0.0625f, 0.0625f);
        ...
        {
            GameObject raySetupObj = new GameObject("UIRaySetup");
            SimpleUIRaySetup raySetup = raySetupObj.AddComponent<SimpleUIRaySetup>();
            raySetup.SetupUIRayInteraction();
        }
    }
}