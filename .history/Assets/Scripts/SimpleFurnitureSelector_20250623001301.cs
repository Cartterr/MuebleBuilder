    ...
    public class SimpleFurnitureSelector : MonoBehaviour
    {
                ...
                private void ConnectDirectButtons()
        {
            ...
            if (salirButton != null)
            {
                ...
                Debug.Log("✅ SalirButton connected");
                        ...
                        public void SelectFurnitureSet(string setPrefix)
        {
            if (isProcessingSelection)
            {
        ...
        private void ExitApplication()
        {
            ...
            Application.Quit();
                        ...
                        [ContextMenu("🪑 Select Mueble 1")]
        public void SelectMueble1()
        {
            Debug.Log("🪑🪑🪑 PUBLIC: MUEBLE 1 SELECTED! 🪑🪑🪑");
            if (!isProcessingSelection)
            {
                SelectFurnitureSet("1");
            }
        ...
        [ContextMenu("🪑 Select Mueble 2")]
        public void SelectMueble2()
        {
            Debug.Log("🪑🪑🪑 PUBLIC: MUEBLE 2 SELECTED! 🪑🪑🪑");
            if (!isProcessingSelection)
            {
                SelectFurnitureSet("2");
            }
        ...
        [ContextMenu("🪑 Select Mueble 3")]
        public void SelectMueble3()
        {
            Debug.Log("🪑🪑🪑 PUBLIC: MUEBLE 3 SELECTED! 🪑🪑🪑");
            if (!isProcessingSelection)
            {
                SelectFurnitureSet("3");
            }
        ...
        {
            Debug.Log("👋 PUBLIC: SALIR PRESSED - EXITING!");
            if (!isProcessingSelection)
            {
                ExitApplication();
            }
