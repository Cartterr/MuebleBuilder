    ...
    public class PhysicalButton : MonoBehaviour
    {
        ...
        private IEnumerator AnimatePress()
        {
                        ...
                        while (Vector3.Distance(transform.localScale, targetScale) > 0.01f)
            {
                ...
                {
                    buttonMaterial.color = Color.Lerp(buttonMaterial.color, pressedColor, Time.deltaTime * animationSpeed);
                }
        ...
        private IEnumerator AnimateRelease()
        {
                        while (Vector3.Distance(transform.localScale, originalScale) > 0.01f)
            {
                ...
                if (buttonMaterial != null)
                {
                    buttonMaterial.color = Color.Lerp(buttonMaterial.color, originalColor, Time.deltaTime * animationSpeed);
                }
        ...
        private IEnumerator ButtonPressEffect()
        {
            ...
            while (elapsed < duration)
            {
                ...
                if (buttonMaterial != null)
                {
                    buttonMaterial.color = Color.Lerp(Color.white, originalColor, progress);
                }
