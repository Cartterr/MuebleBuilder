...
namespace VRProject
{
    public class AutoMenuSetup : MonoBehaviour
    {
        ...
        public void CreateMenuManager()
        {
            ...
            SimpleMenuController simpleController = managerObj.AddComponent<SimpleMenuController>();
            ...
            Debug.Log("✅ Created both SimpleMenuController and FurnitureSelectionManager");
        }
                ...
                private void ConnectButtonEvents()
        {
            ...
            SimpleMenuController simpleController = FindObjectOfType<SimpleMenuController>();
            if (simpleController != null)
            {
                Debug.Log("✅ Found SimpleMenuController - using simple approach!");
                Debug.Log("🔗✅ SimpleMenuController will handle all button events automatically!");
                return;
            }

            Debug.Log("⚠️ No SimpleMenuController found, falling back to FurnitureSelectionManager...");
