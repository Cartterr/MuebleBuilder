    ...
    public class AutoMenuSetup : MonoBehaviour
    {
        ...
        public void CreateCompleteMenuSystem()
        {
            ...
            try
            {
                ...
                Debug.Log("🎯 Step 8: SimpleFurnitureSelector will handle button events automatically");
        ...
        public void CreateMenuManager()
        {
            ...
            Debug.Log("✅ Created SimpleFurnitureSelector - Direct 3-button furniture selection");
        }
