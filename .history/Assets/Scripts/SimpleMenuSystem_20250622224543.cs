...
namespace VRProject
{
    public class SimpleMenuSystem : MonoBehaviour
    {
                ...
                private void Start()
        {
            ...
            Debug.Log("⏰ Waiting for manual initialization...");
        }

        public void InitializeMenuSystem()
        {
            Debug.Log("🚀🚀🚀 MANUAL INITIALIZATION STARTING 🚀🚀🚀");
        ...
        private void ConnectPhysicalButtons()
        {
            ...
            {
                Button buttonComponent = iniciarButton.GetComponent<Button>();
                ...
                if (buttonComponent != null)
                {
                    ...
                    buttonComponent.onClick.AddListener(() => {
                        Debug.Log("🚀🚀🚀 INICIAR BUTTON PRESSED! 🚀🚀🚀");
                ...
                {
                    Debug.LogError("❌ RED X RED - IniciarButton has no Button component!");
                }
                ...
                {
                    Debug.Log("✅ IniciarButton has PhysicalButton component for VR interaction");
                }
            }

            if (salirButton != null)
            {
                Button buttonComponent = salirButton.GetComponent<Button>();
                ...
                {
                    Debug.LogError("❌ RED X RED - SalirButton has no Button component!");
                }
                ...
                {
                    Debug.Log("✅ SalirButton has PhysicalButton component for VR interaction");
                }
            }

            if (backButton != null)
            {
                Button buttonComponent = backButton.GetComponent<Button>();
                ...
                {
                    Debug.LogError("❌ RED X RED - BackButton has no Button component!");
                }
                ...
                {
                    Debug.Log("✅ BackButton has PhysicalButton component for VR interaction");
                }
            }
        }
