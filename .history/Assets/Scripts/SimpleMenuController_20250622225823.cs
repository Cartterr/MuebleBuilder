...
namespace VRProject
{
    public class SimpleMenuController : MonoBehaviour
    {
                ...
                private void ConnectButtonEvents()
        {
            ...
            if (iniciarButton != null)
            {
                Button uiButton = iniciarButton.GetComponent<Button>();
                if (uiButton != null)
                {
                    ...
                    Debug.Log("✅ INICIAR button connected via UI Button");
                }
                else
                {
                    Debug.LogError("❌ RED X RED - INICIAR PhysicalButton has no UI Button component!");
                }
            }
            else
            {
            ...
            if (salirButton != null)
            {
                Button uiButton = salirButton.GetComponent<Button>();
                if (uiButton != null)
                {
                    uiButton.onClick.RemoveAllListeners();
                    uiButton.onClick.AddListener(() => {
                    ...
                    Debug.Log("✅ SALIR button connected via UI Button");
                }
                else
                {
                    Debug.LogError("❌ RED X RED - SALIR PhysicalButton has no UI Button component!");
                }
            }

            if (backButton != null)
            {
                Button uiButton = backButton.GetComponent<Button>();
                if (uiButton != null)
                {
                    uiButton.onClick.RemoveAllListeners();
                    uiButton.onClick.AddListener(() => {
                    ...
                    Debug.Log("✅ BACK button connected via UI Button");
                }
                else
                {
                    Debug.LogError("❌ RED X RED - BACK PhysicalButton has no UI Button component!");
                }
            }
        }
