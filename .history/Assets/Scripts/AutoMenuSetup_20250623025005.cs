...
namespace VRProject
{
    ...
    public class AutoMenuSetup : MonoBehaviour
    {
                ...
                private void CreateInstructionPanelIfNotExists()
        {
            ...
            canvasRect.sizeDelta = new Vector2(0.03f, 0.008f);
            ...
            bgRect.sizeDelta = new Vector2(0.03f, 0.008f);

            Image bgImage = backgroundPanel.GetComponent<Image>();
            bgImage.color = new Color(0.1f, 0.15f, 0.3f, 0.9f);
        ...
        private GameObject CreateRoundedPanel(string name, Transform parent)
        {
            ...
            Texture2D roundedTexture = CreateRoundedRectTexture(20, 10, 2);
