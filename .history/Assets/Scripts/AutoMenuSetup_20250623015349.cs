...
namespace VRProject
{
    ...
    public class AutoMenuSetup : MonoBehaviour
    {
        ...
        {
            new InstructionData { objectName = "furniture_1_1", instructionText = "Connect this base piece to start building your furniture", displayDuration = 4f },
            new InstructionData { objectName = "furniture_1_2", instructionText = "Attach this piece to the main structure", displayDuration = 3f },
            new InstructionData { objectName = "furniture_1_3", instructionText = "This is the finishing piece - place it on top", displayDuration = 3f },
            new InstructionData { objectName = "furniture_2_1", instructionText = "Begin with this foundation piece", displayDuration = 4f },
            new InstructionData { objectName = "furniture_2_2", instructionText = "Connect this middle section carefully", displayDuration = 3f },
            new InstructionData { objectName = "furniture_2_3", instructionText = "Complete the assembly with this final piece", displayDuration = 3f },
            new InstructionData { objectName = "furniture_3_1", instructionText = "Start your build with this corner piece", displayDuration = 4f },
            new InstructionData { objectName = "furniture_3_2", instructionText = "Align this piece with the corner base", displayDuration = 3f },
            new InstructionData { objectName = "furniture_3_3", instructionText = "Finish by placing this top component", displayDuration = 3f }
        };
        ...
        public void CreateCompleteMenuSystem()
        {
            ...
            try
            {
                ...
                Debug.Log("🎯 Step 8: SimpleFurnitureSelector will handle furniture automatically");
                Debug.Log("✅ Furniture selection will be handled by SimpleFurnitureSelector");

                Debug.Log("🎯 Step 9: SimpleFurnitureSelector will handle button events automatically");
        ...
        private void CreateRestartButtonIfNotExists()
        {
            ...
            {
                Debug.Log("✅ RestartButtonParent already exists, skipping creation");

                RestartButtonSetup existingSetup = existingRestart.GetComponent<RestartButtonSetup>();
                if (existingSetup == null)
                {
                    Debug.Log("Adding missing RestartButtonSetup component");
                ...
                if (simpleSelector != null && simpleSelector.restartButtonSetup == null)
                {
                    simpleSelector.restartButtonSetup = existingSetup;
            ...
            {
                simpleSelector.restartButtonSetup = setup;
                Debug.Log("🔴 Restart button created and connected to SimpleFurnitureSelector!");
            }
        }
        ...
        private void CreateInstructionPanelIfNotExists()
        {
            ...
            {
                Debug.Log("✅ InstructionPanel already exists, checking components...");

                InstructionPanelController existingController = existingPanel.GetComponent<InstructionPanelController>();
                if (existingController == null)
                {
                    Debug.Log("Adding missing InstructionPanelController component");
