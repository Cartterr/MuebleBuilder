...
namespace VRProject
{
    public class MegaAutoSetup : MonoBehaviour
    {
        ...
        private void WireAllButtons()
        {
            ...
            PhysicalButton[] allButtons = FindObjectsOfType<PhysicalButton>();
            ...
            foreach (PhysicalButton button in allButtons)
            {
