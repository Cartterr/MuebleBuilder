...
namespace VRProject
{
    public class AutoMenuSetup : MonoBehaviour
    {
        ...
        {
            // Title
            CreateText("MuebleBuilder", parent, new Vector2(0, 50), 24);

            // Iniciar Button
            CreateButton("IniciarButton", "INICIAR", parent, new Vector2(0, 0), new Vector2(120, 40));

            // Salir Button
            CreateButton("SalirButton", "SALIR", parent, new Vector2(0, -50), new Vector2(120, 40));
        }

                private void CreateModelSelectionContent(Transform parent)
        {
            // Title
            CreateText("Selecciona tu Mueble", parent, new Vector2(0, 120), 20);

            // Back Button
            CreateButton("BackButton", "◀ VOLVER", parent, new Vector2(-150, 120), new Vector2(100, 30));
