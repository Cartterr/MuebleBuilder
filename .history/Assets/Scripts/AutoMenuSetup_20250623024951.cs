...
namespace VRProject
{
    ...
    public class AutoMenuSetup : MonoBehaviour
    {
                ...
                private void CreateInstructionPanelIfNotExists()
        {
            ...
            textRect.anchorMin = Vector2.zero;
            textRect.anchorMax = Vector2.one;
            textRect.offsetMin = new Vector2(0.005f, 0.0025f);
            textRect.offsetMax = new Vector2(-0.005f, -0.0025f);
            ...
            instructionText.fontSize = 0.002f;
            instructionText.color = new Color(1f, 1f, 1f, 1f);
